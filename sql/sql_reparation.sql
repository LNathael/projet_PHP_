...
-- Listage des données de la table projet_php_.panier : ~1 rows (environ)
...
INSERT INTO `produits` (`id_produit`, `nom_produit`, `description`, `prix`, `quantite_disponible`, `libelle`, `image`) VALUES
	...
	(9, 'LE BIHAN', 'je suis trop beau , putain de merde', 10000.00, 1, NULL, 'uploads/produits/produit_67815eef3ab84.png');
...
INSERT INTO `utilisateurs` (`id_utilisateur`, `nom`, `prenom`, `email`, `bio`, `objectifs_fitness`, `objectif`, `mot_de_passe`, `role`, `date_naissance`, `sexe`, `date_creation`, `photo_profil`, `badge`) VALUES
	(1, 'Le Bihan', 'Nathaël', 'xarunax69@gmail.com', '', '', '', '$2y$10$j3VjdNMrOq4gyFpKUDs9MOOLRbT4oCohOvzD.TFOhgz17joIST1Oy', 'administrateur', '2005-10-12', 'Homme', '2024-12-11 20:54:21', 'uploads/profils/Fichier_000.png', NULL),
	(2, 'LE BIHAN', 'Nathaël', 'nathael.lebihan12102005@gmail.com', NULL, NULL, NULL, '$2y$10$D03sL3VkP9kD.LRdaljwu.KpvbtU37P7.4yAwkRWL9JbLLrHX8ONi', 'utilisateur', '2005-10-12', 'Homme', '2024-12-20 11:39:16', NULL, NULL),
	(6, 'Nathael', 'dsdza', 'nathael.lebihanIDBZSDZOILD@gmail.com', NULL, NULL, NULL, '$2y$10$WXEO6NJOY/qJ.K2PXSxavOsnSNexYMMbbP0xjszBmbt.6AO9ec4Y6', 'super_administrateur', '2055-10-12', 'Homme', '2025-02-14 16:03:52', NULL, NULL),
	(7, 'LE BIHAN', 'Nathaël', 'xarunax68@gmail.com', NULL, NULL, NULL, '$2y$10$OPoyVHXYDQGYOlrVt56hiuOPNkrT3NEzx9hUBOpwnf.uqQtKokEaW', 'super_administrateur', '2005-10-12', 'Homme', '2025-02-17 10:39:04', NULL, NULL),
	(8, 'Perin', 'Yanis', 'yanis@perin.fr', NULL, NULL, NULL, '$2y$10$AfRQPB6.us5k/1MJ5Jv0cup6iGaj3kCI301CZPAAnvG7Id1R1Lyzy', 'utilisateur', '2025-12-03', 'Femme', '2025-03-17 09:11:54', NULL, NULL),
	(9, 'yanis', 'Perin', 'yanis.perin@gmail.com', NULL, NULL, NULL, '$2y$10$iU3tBG3BFwZVq5.3x5VGZejDJBxMnAHQoQLS3SAg.qcCibSVZjVUO', 'utilisateur', '2005-10-12', 'Homme', '2025-03-17 10:11:58', NULL, NULL);
