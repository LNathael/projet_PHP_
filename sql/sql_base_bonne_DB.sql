...
-- Listage de la structure de table projet_php. messages
...
-- Listage des données de la table projet_php.messages : ~0 rows (environ)
INSERT INTO `messages` (`id_message`, `id_utilisateur`, `id_salon`, `contenu`, `date_message`) VALUES
	(1, 7, 1, 'salut', '2025-02-17 14:06:52'),
	(2, 7, 1, 'test', '2025-02-17 14:06:57'),
	(3, 7, 1, 'salut', '2025-02-17 14:15:23'),
	(4, 7, 1, 'test2', '2025-02-17 14:18:15'),
	(5, 7, 1, 'heheh', '2025-02-17 14:20:43'),
	(6, 7, 3, 'truc', '2025-02-17 14:22:25'),
	(7, 7, 1, 'dd', '2025-02-17 14:22:38');
...
-- Listage des données de la table projet_php.produits : ~2 rows (environ)
...
-- Listage des données de la table projet_php.recettes : ~2 rows (environ)
...
-- Listage de la structure de table projet_php. salons
...
-- Listage des données de la table projet_php.salons : ~0 rows (environ)
...
-- Listage des données de la table projet_php.user_programs : ~9 rows (environ)
...
-- Listage des données de la table projet_php.utilisateurs : ~6 rows (environ)
INSERT INTO `utilisateurs` (`id_utilisateur`, `nom`, `prenom`, `email`, `mot_de_passe`, `role`, `date_naissance`, `sexe`, `date_creation`) VALUES
	...
	(6, 'Nathael', 'dsdza', 'nathael.lebihanIDBZSDZOILD@gmail.com', '$2y$10$WXEO6NJOY/qJ.K2PXSxavOsnSNexYMMbbP0xjszBmbt.6AO9ec4Y6', 'super_administrateur', '2055-10-12', 'Homme', '2025-02-14 16:03:52'),
	(7, 'LE BIHAN', 'Nathaël', 'xarunax68@gmail.com', '$2y$10$OPoyVHXYDQGYOlrVt56hiuOPNkrT3NEzx9hUBOpwnf.uqQtKokEaW', 'super_administrateur', '2005-10-12', 'Homme', '2025-02-17 10:39:04');
