...
$stmt = $pdo->prepare("
    SELECT m.*, u.nom, u.prenom, u.role, r.titre AS recette_titre, r.image AS recette_image, p.nom_produit, p.image AS produit_image 
    FROM messages m
...
<div class="container mt-5">
    ...
    <?php if ($salon['nom_salon'] != '#Annonces' || (isset($_SESSION['role']) && in_array($_SESSION['role'], ['administrateur', 'super_administrateur', 'commercial']))): ?>
        <form method="POST" action="send_message.php" class="mt-4">
            ...
            <textarea class="textarea" name="contenu" placeholder="Écrivez votre message..." required></textarea>
